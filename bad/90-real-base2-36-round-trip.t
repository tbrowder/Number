...
$res = w-rebase :num-i('011011010110'), :base-i(2), :base-o(10);
#is $res.Numeric, '1750'.Numeric;
is $res, '1750';

$res = w-rebase :num-i('1750'), :base-i(10), :base-o(2);
#is $res.Numeric, '011011010110'.Numeric;
is $res, '011011010110';
